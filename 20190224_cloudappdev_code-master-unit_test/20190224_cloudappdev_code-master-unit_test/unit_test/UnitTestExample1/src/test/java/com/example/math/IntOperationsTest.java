...
public class IntOperationsTest extends TestCase {
	...
	public void test_multiply() {
		IntOperations io = new IntOperations();
		Assert.assertEquals(0, io.multiply(0, 1));
		Assert.assertEquals(1, io.multiply(1, 1));
		Assert.assertEquals(4, io.multiply(2, 2));
		
		Assert.assertEquals(Integer.MAX_VALUE*2, io.multiply(Integer.MAX_VALUE, 2));
		Assert.assertEquals(Integer.MAX_VALUE*2, io.multiply(2, Integer.MAX_VALUE));
		
		Assert.assertEquals(Integer.MIN_VALUE*2, io.multiply(Integer.MIN_VALUE, 2));
		Assert.assertEquals(Integer.MIN_VALUE*2, io.multiply(2, Integer.MIN_VALUE));
		
		Assert.assertEquals(Integer.MIN_VALUE+Integer.MIN_VALUE, io.multiply(Integer.MIN_VALUE, 2));
		Assert.assertEquals(Integer.MAX_VALUE+Integer.MAX_VALUE, io.multiply(Integer.MAX_VALUE, 2));
	}
}
